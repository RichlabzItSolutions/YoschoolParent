package com.credoapp.parent.views;
...
import com.credoapp.parent.listeners.OnCalendarPageChangeListener;
import com.credoapp.parent.listeners.OnDayClickListener;
import com.credoapp.parent.views.adapters.CalendarPageAdapter;
import com.credoapp.parent.views.extensions.CalendarViewPager;
import com.credoapp.parent.views.utils.AppearanceUtils;
...
import static com.credoapp.parent.views.adapters.CalendarPageAdapter.CALENDAR_SIZE;
...
//        mCurrentMonthLabel.setText(DateUtils.getMonthAndYearDate(mContext, calendar));
    ...
    public void setDate(Calendar date) throws OutOfDateRangeException {
        ...
        Log.d(TAG, " FIRST_VISIBLE_PAGE " + (-FIRST_VISIBLE_PAGE));
