...
//        });
        builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                List<Integer> selectedSubjectsList = getSelectedIndices();

                int s = selectedSubjectsList.size();



                if (s>0){
                    Log.d("Selected"," at least one language          "+ Arrays.toString(mSelection) +"      "+ Arrays.toString(mSelectionAtStart));
